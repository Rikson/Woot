...
${OBJECTDIR}/dictionary/impl/DictionaryManager.o: dictionary/impl/DictionaryManager.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/dictionary/impl/DictionaryManager.o dictionary/impl/DictionaryManager.cpp

${OBJECTDIR}/dictionary/impl/CountDictionaryManager.o: dictionary/impl/CountDictionaryManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/dictionary/impl
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/dictionary/impl/CountDictionaryManager.o dictionary/impl/CountDictionaryManager.cpp
...
${OBJECTDIR}/dictionary/impl/CountDictionary.o: dictionary/impl/CountDictionary.cpp 
	${MKDIR} -p ${OBJECTDIR}/dictionary/impl
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/dictionary/impl/CountDictionary.o dictionary/impl/CountDictionary.cpp
